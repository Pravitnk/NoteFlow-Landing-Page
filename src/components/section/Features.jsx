  ...
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url('../src/assets/Noise.webp')] bg-repeat">
      <div className="text-primary-50 relative m-auto max-w-[90rem] px-24 py-32 max-xl:px-16 max-xl:py-24 max-lg:px-8">
        ...
        <h2 className="mb-28 text-center text-6xl/18 font-semibold tracking-tight max-xl:mb-18 max-xl:text-5xl/16 max-lg:text-4xl/10">
        ...
        <div className="mb-20 grid grid-cols-2 items-center gap-x-16 max-xl:mb-12">
          ...
          <div className="z-1 max-w-lg justify-self-end">
            <p className="m mb-8 text-5xl/16 font-semibold tracking-tight max-xl:mb-6 max-xl:text-4xl/10 max-lg:mb-4 max-lg:text-3xl/12">
              Smart Organization
            </p>
        ...
        <div className="grid grid-cols-2 items-center gap-x-16 max-xl:mb-12">
          <div className="max-w-lg justify-self-start">
            <p className="mb-8 text-5xl/16 font-semibold tracking-tight max-xl:mb-6 max-xl:text-4xl/10 max-lg:mb-4 max-lg:text-3xl/12">
